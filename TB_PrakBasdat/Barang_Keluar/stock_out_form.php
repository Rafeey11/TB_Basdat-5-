...
<div class="container mt-5">
  <h2 class="mb-4 text-center">📤 Formulir Barang Keluar</h2>

  <form method="POST" action="stock_out_process.php">
    <div class="row mb-3">
      <div class="col-md-6 offset-md-3">
        <label for="item_id" class="form-label">Pilih Item:</label>
        <select name="item_id" id="item_id" class="form-select" required>
          <?php
          $result = $conn->query("SELECT id, item_name FROM items");
    ...
    <div class="row mb-3">
      <div class="col-md-6 offset-md-3">
        ...
        <input type="text" name="destination" id="destination" class="form-control" placeholder="Masukan Tujuan..." required>
      </div>
    </div>
